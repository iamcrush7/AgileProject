...
import { ShieldCheck, Banknote, Zap, MapPin, Languages, LucideIcon } from "lucide-react"
...
const TrustCard = ({ feature, idx, isInView }: { feature: TrustFeature, idx: number, isInView: boolean }) => {
