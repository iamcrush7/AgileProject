        ...
        <header className="h-16 flex-shrink-0 flex items-center justify-between px-6 border-b border-border bg-surface z-30">
            ...
            <div className="flex items-center gap-3">
                ...
                <div className="relative">
                    ...
                    >
                        <div className="h-7 w-7 rounded-full border-2 border-background shadow-sm overflow-hidden font-bold flex items-center justify-center text-xs shrink-0 bg-primary text-background relative">
                            {user?.image ? (
                                <Image src={user.image} alt={user.name || "User"} className="h-full w-full object-cover" fill />
                            ) : (
                                initial
                            )}
                        </div>
