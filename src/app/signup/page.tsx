...
import { Mail, Lock, User, Phone, MapPin, Briefcase, Languages, FileText, Eye, EyeOff, ArrowRight, Check, LucideIcon } from "lucide-react"
...
function FieldInput({ icon: Icon, ...props }: { icon: LucideIcon } & React.InputHTMLAttributes<HTMLInputElement>) {
    return (
...
function SelectInput({ icon: Icon, children, ...props }: { icon: LucideIcon } & React.SelectHTMLAttributes<HTMLSelectElement>) {
    return (
        <div className="relative">
...
export default function SignupPage() {
    ...
    async function handleSignup(e: React.FormEvent) {
        ...
        setError("")
        try {
            const body: Record<string, unknown> = { name, email, phone, state, city, password, role }
            if (role === "PROVIDER") {
