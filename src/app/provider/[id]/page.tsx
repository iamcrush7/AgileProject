...
import { MapPin, Star, ShieldCheck, Clock, Award, Sparkles, AlertCircle, ChevronRight, Calendar, MessageSquare, BadgeCheck, Share2, Heart, Tag } from "lucide-react"
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                    ...
                    <div className="lg:col-span-2">
                        ...
                        <div className="flex flex-col md:flex-row gap-8 mb-10">
                            ...
                            >
                                {provider.image ? (
                                    <Image src={provider.image} className="w-full h-full object-cover" alt={provider.name} fill />
                                ) : (
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <button
                                                onClick={() => {
                                                    ...
                                                    router.push(`/messages?with=${provider?.id}`)
                                                }}
                                                className="p-4 rounded-xl border border-border bg-surface flex items-center justify-between hover:border-primary transition-colors cursor-pointer group w-full"
                                            >
                                                ...
                                                <div className="text-[10px] bg-indigo-500/20 text-indigo-600 px-2 py-0.5 rounded-full font-bold">Live</div>
                                            </button>
                                        </div>
                                    </div>
                                </div>
