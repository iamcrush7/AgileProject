...
export default function ProviderJobsPage() {
    ...
    type TabType = "PENDING" | "CONFIRMED" | "IN_PROGRESS" | "COMPLETED" | "ALL"
                            ...
                            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                                <div className="flex-1">
                                    ...
                                    {(() => {
                                        ...
                                        const addrLine = lines.find((l: string) => l.startsWith("SERVICE ADDRESS:"))
                                        const address = addrLine ? addrLine.replace("SERVICE ADDRESS:", "").trim() : null
                                        const extraNotes = lines.filter((l: string) => !l.startsWith("SERVICE ADDRESS:")).join("\n").trim()
